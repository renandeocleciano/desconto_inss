...
class FaixaContribuicaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faixa_contribuicao" do
    assert_difference("FaixaContribuicao.count") do
      post faixa_contribuicaos_url, params: { faixa_contribuicao: { aliquota: @faixa_contribuicao.aliquota, max: @faixa_contribuicao.max, min: @faixa_contribuicao.min } }
    end
  ...
  test "should update faixa_contribuicao" do
    patch faixa_contribuicao_url(@faixa_contribuicao), params: { faixa_contribuicao: { aliquota: @faixa_contribuicao.aliquota, max: @faixa_contribuicao.max, min: @faixa_contribuicao.min } }
