...
class ProponentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create proponente' do
    assert_difference('Proponente.count') do
      post proponentes_url,
           params: { proponente: { cpf: @proponente.cpf, data_nascimento: @proponente.data_nascimento, nome: @proponente.nome,
                                   recolhido: @proponente.recolhido, salario: @proponente.salario } }
    end
  ...
  test 'should update proponente' do
    patch proponente_url(@proponente),
          params: { proponente: { cpf: @proponente.cpf, data_nascimento: @proponente.data_nascimento, nome: @proponente.nome,
                                  recolhido: @proponente.recolhido, salario: @proponente.salario } }
