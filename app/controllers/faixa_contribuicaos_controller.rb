  ...
  def create
    ...
    respond_to do |format|
      if @faixa_contribuicao.save
        format.html do
          redirect_to faixa_contribuicao_url(@faixa_contribuicao),
                      notice: 'Faixa contribuicao was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @faixa_contribuicao.update(faixa_contribuicao_params)
        format.html do
          redirect_to faixa_contribuicao_url(@faixa_contribuicao),
                      notice: 'Faixa contribuicao was successfully updated.'
        end
